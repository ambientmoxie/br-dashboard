...
class UIManager {
    ...
    rebuildUI() {
        ...
        // The collapsible uses "max-height" with a CSS transition to reveal the dropdown options
        // with animation. The "max-height" must be updated after the UI is rebuilt to match
        // the new dropdown content height.
        this.fixeCollapsiblesMaxHeight();
    ...
    rebuildBoard(keys) {
        ...
        servedSizes.forEach((servedSize) => {
            ...
            bannerFooter.innerHTML = `<span></span><p>${bannerWidth} x ${bannerHeight}</p>`;
